...
export const metadata = {
  title: "Best TikTok Creators for Fitness Niche | VoxCry AI-Powered Creator Vetting",
  description:
    "Curated list of fitness, wellness, and coaching creators scored on engagement quality and risk — built for brands, agencies, and UGC buyers who care about performance, not hype.",
  keywords: [
    "TikTok fitness creators",
    "best TikTok creators for fitness",
    ...
    "VoxCry fitness creators",
  ],
};

import Link from "next/link";
import Generator from "../../components/Generator"; // adjust path if your folder structure is different
  ...
  return (
    <main className="px-4 py-10">
      <div className="mx-auto max-w-6xl">
        ...
        <header className="mb-10 flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <h1 className="mt-1 text-4xl font-bold tracking-tight">
              Fitness TikTok Creators Vetted by VoxCry
            </h1>

            <p className="mt-3 max-w-2xl text-sm text-gray-500">
              Curated list of fitness, wellness, and coaching creators scored on
          ...
          <aside className="w-full max-w-sm md:mt-2">
            <div className="rounded-lg bg-gray-100 px-4 py-3 text-xs text-gray-600">
              <div className="mb-1 flex items-center justify-between">
                ...
                <span className="font-semibold">Fitness niche</span>
              </div>
              <p>
        ...
        {/* Divider, matching beauty page */}
        <hr className="border-gray-200" />

        {/* Client component renders "All Creators" + table/cards,
            styled the same way as BeautyCreatorsClient */}
        <section className="mt-6">
          <Generator niche="fitness" category="all" />
        </section>
      </div>
    </main>
  );
