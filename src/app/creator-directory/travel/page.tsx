...
export const metadata = {
  title: "Best TikTok Creators for Travel Niche | VoxCry AI-Powered Creator Vetting",
  description:
    "Curated list of travel, exploration, and lifestyle creators scored on engagement quality and risk — built for brands, agencies, and UGC buyers who care about performance, not hype.",
  keywords: [
    "TikTok travel creators",
    "best TikTok creators for travel",
    ...
    <main className="px-4 py-10">
      <div className="mx-auto max-w-6xl">
        ...
        <header className="mb-10 flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <h1 className="mt-1 text-4xl font-bold tracking-tight">
              Travel TikTok Creators Vetted by VoxCry
            </h1>

            <p className="mt-3 max-w-2xl text-sm text-gray-500">
              Curated list of travel, exploration, and lifestyle adventure
          ...
          <aside className="w-full max-w-sm md:mt-2">
            <div className="rounded-lg bg-gray-100 px-4 py-3 text-xs text-gray-600">
              <div className="mb-1 flex items-center justify-between">
                ...
                <span className="font-semibold">Travel niche</span>
              </div>
              <p>
        ...
        <section className="mt-6">
          <Generator niche="travel" category="all" />
        </section>
      </div>
    </main>
  );
